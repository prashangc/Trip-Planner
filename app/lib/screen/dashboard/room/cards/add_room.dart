...
Widget addRoom(context) {
  RoomState model = BlocProvider.of<RoomBloc>(context).state;
  return Column(
      ...
      myButton(
        ...
        myTap: () {
          BlocProvider.of<RoomBloc>(context)
              .add(AddRoomBtnTapEvent(model: model, context: context));
        },
        validateKeys: roomBloc.formKeys,
      ),
      sizedBox12(),
    ],
  );
